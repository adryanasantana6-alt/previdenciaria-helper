    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-serif text-foreground">Assistente Previdenciário</h1>
          <p className="text-sm text-muted-foreground mt-1">Adriana Santana — Advocacia</p>
        </div>
